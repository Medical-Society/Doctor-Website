...
const AppointmentsOption = ({} : IProps) => {
    return (
        ...
        <div className='md:space-y-10 md:w-2/5 space-y-5 mb-5 '>
          ...
          <h2   data-aos="fade-up" data-aos-duration="2000"  className='text-black text-2xl w-70 font-serif text-center'>Our system is going to help you to manage your appointments</h2>
        </div>
