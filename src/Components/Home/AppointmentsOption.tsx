import appointments from '../../assets/Appointments.jpeg'
...
const AppointmentsOption = ({} : IProps) => {
    return (
        ...
        <div className='md:space-y-10 md:w-2/5 space-y-5 mb-5 '>
          <h1 className="text-center text-violet-950 text-3xl font-cairo">Manage your appointments</h1>
          <h2   className='text-black text-2xl w-70 font-cairo text-center'>Our system is going to help you to manage your appointments</h2>
        </div>
